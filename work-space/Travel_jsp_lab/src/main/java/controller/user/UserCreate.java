...
public class UserCreate extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
	    ...
	    req.getRequestDispatcher("/view/admin/UserCreate.jsp").forward(req, resp);
	}
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if(username == null || email == null || password == null || 
				full_name == null || phone_number == null || address == null) {
			
			req.setAttribute("url", new UrlManage());
			req.setAttribute("notify", "Vui lòng đầy đủ thông tin");
		    req.getRequestDispatcher("/view/admin/UserCreate.jsp").forward(req, resp);

		}
		if(userService.checkExistUser(req)==true) {
			User user = new User(username, password, email, full_name, phone_number, address, role_id);
			req.setAttribute("user", user);
			req.setAttribute("url", new UrlManage());
			req.setAttribute("notify", "Tài khoản và email đã tồn tại");
		    req.getRequestDispatcher("/view/admin/UserCreate.jsp").forward(req, resp);
